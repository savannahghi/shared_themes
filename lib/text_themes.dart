...
class TextThemes {
  ...
  //size 45
  static TextStyle boldSize45Text([Color? color]) =>
      GoogleFonts.montserrat(fontSize: 45, color: color, fontWeight: FontWeight.w500);
  ...
  //size 32
  static TextStyle veryBoldSize32Text([Color? color]) =>
      GoogleFonts.montserrat(fontWeight: FontWeight.w600, color: color, fontSize: 32);

  static TextStyle normalSize32Text([Color? color]) =>
      GoogleFonts.montserrat(fontSize: 32, color: color);

//size30
  static TextStyle boldSize30Text([Color? color]) =>
      GoogleFonts.montserrat(fontSize: 30, fontWeight: FontWeight.w500, color: color);

//size28
  static TextStyle veryBoldSize28Text([Color? color]) =>
      GoogleFonts.montserrat(fontWeight: FontWeight.w600, color: color, fontSize: 28);

  static TextStyle normalSize28Text([Color? color]) =>
      GoogleFonts.montserrat(fontSize: 28, color: color);

//size26
  static TextStyle heavySize28Text([Color? color]) =>
      GoogleFonts.montserrat(color: color, fontWeight: FontWeight.w700, fontSize: 28);

  static TextStyle heavySize26Text([Color? color]) =>
      GoogleFonts.montserrat(color: color, fontWeight: FontWeight.w700, fontSize: 26);

  static TextStyle normalSize26Text([Color? color]) =>
      GoogleFonts.montserrat(fontSize: 26, color: color);

  static TextStyle boldSize26Title([Color? color]) =>
      GoogleFonts.montserrat(fontSize: 26, color: color, fontWeight: FontWeight.w500);

//size24

  static TextStyle heavySize24Text([Color? color]) =>
      GoogleFonts.montserrat(color: color, fontWeight: FontWeight.w700, fontSize: 24);

  static TextStyle mediumSize24Text([Color? color]) =>
      GoogleFonts.montserrat(color: color, fontWeight: FontWeight.w600, fontSize: 24);

  static TextStyle mediumSize20Text([Color? color]) =>
      GoogleFonts.montserrat(color: color, fontWeight: FontWeight.w500, fontSize: 20);

  static TextStyle mediumSize22Text([Color? color]) =>
      GoogleFonts.montserrat(color: color, fontWeight: FontWeight.w500, fontSize: 22);

  static TextStyle boldSize24Text([Color? color]) =>
      GoogleFonts.montserrat(color: color, fontWeight: FontWeight.w500, fontSize: 24);

  static TextStyle normalSize24Text([Color? color]) =>
      GoogleFonts.montserrat(color: color, fontSize: 24);

//size 22
  static TextStyle veryBoldSize22Text([Color? color]) =>
      GoogleFonts.montserrat(fontWeight: FontWeight.w600, color: color, fontSize: 22);

  static TextStyle boldSize22Text([Color? color]) =>
      GoogleFonts.montserrat(fontWeight: FontWeight.w500, color: color, fontSize: 22);

  static TextStyle normalSize22Text([Color? color]) =>
